...
const DEFAULTS: SiteContent = {
  ...
  hero_title2_ar: "مع صداوة للمواهب",
  hero_title2_en: "With Sadaawah Talent AI",
  ...
  logo_url: null,
  apply_title_ar: "انضم لفريق صداوة للمواهب",
  apply_title_en: "Join the Sadaawah Talent AI Team",
